                        ...
                        <?php if ($lecturers->num_rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-sm btn-danger text-white rounded-pill px-3" href="index.php?page=lecturer&action=delete&id=<?= $row['id'] ?>" onclick="return confirm('Oh no! Are you really sure you want to delete this?')">Delete</a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        <?php else: ?>

                        ...
                        <?php if ($courses->num_rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a class="btn btn-sm btn-danger text-white rounded-pill px-3" href="index.php?page=course&action=delete&id=<?= $row['id'] ?>" onclick="return confirm('Wait! Do you really want to say goodbye to this data?')">Delete</a>
                                </td>
                            </tr>
                            <?php endwhile; ?>
                        <?php else: ?>

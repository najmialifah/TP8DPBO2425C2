...
<div class="col-lg-6 m-auto">
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="index.php?page=course&action=edit&id=<?= $row['id'] ?>">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label>SKS</label>
                    <input type="number" name="sks" value="<?= $row['sks'] ?>" class="form-control" required>
                </div>
                <div class="mb-3">
                    ...
                    <select name="lecturer_id" class="form-select">
                        ...
                        <?php while($lec = $lecturers->fetch_assoc()): ?>
                            <option value="<?= $lec['id'] ?>" <?= ($lec['id'] == $row['lecturer_id']) ? 'selected' : '' ?>>
                                <?= $lec['name'] ?>
                            </option>
                        <?php endwhile; ?>
                    </select>
